...
public class PlaybackService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private static final String CHANNEL_ID = "Simple channel";
    ...
    public void onDestroy() {
        ...
        new PlaybackPrefs(getApplicationContext()).clearCachedAudioPlaylist();
    }
    ...
    private void skipToNext() {
        ...
        //Update stored index
        new PlaybackPrefs(getApplicationContext()).storeAudioIndex(audioIndex);
    ...
    private void updateMetaData() {
        Bitmap albumArt = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_note_48); //replace with medias albumArt
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_note_48); //replace with your own image
    ...
    private void refreshNotificationAndForeground(PlaybackStatus playbackStatus) {
    ...
    private PendingIntent playbackAction(int actionNumber) {
        Intent playbackAction = new Intent(this, PlaybackService.class);
        switch (actionNumber) {
            case 0:
                // Play
    ...
    private BroadcastReceiver playNewAudio = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            audioIndex = new PlaybackPrefs(getApplicationContext()).loadAudioIndex();
            if (audioIndex != -1 && audioIndex < audioList.size()) {
                //index is in a valid range
                activeAudio = audioList.get(audioIndex);
            } else {
